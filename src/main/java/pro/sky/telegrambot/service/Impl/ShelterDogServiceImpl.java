...
@Component
public class ShelterDogServiceImpl implements ShelterService {
    ...
    @Autowired
    public ShelterDogServiceImpl(ShelterRepository shelterRepository, DrivingDirectionsRepository drivingDirectionsRepository, VolunteerService volunteerService, ClientRepository clientRepository) {
